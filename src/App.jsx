...
const s = {
  ...
  tbl: { width: "100%", borderCollapse: "separate", borderSpacing: 0, fontSize: 15 },
  th: { textAlign: "left", padding: "10px 14px", color: C.muted, fontWeight: 600, fontSize: 13, textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: `1px solid ${C.border}`, background: C.card, whiteSpace: "nowrap" },
  thR: { textAlign: "right", padding: "10px 14px", color: C.muted, fontWeight: 600, fontSize: 13, textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: `1px solid ${C.border}`, background: C.card, whiteSpace: "nowrap" },
  td: { padding: "9px 14px", borderBottom: `1px solid rgba(47,51,54,0.4)`, color: C.text, fontSize: 14 },
  tdR: { padding: "9px 14px", borderBottom: `1px solid rgba(47,51,54,0.4)`, textAlign: "right", fontVariantNumeric: "tabular-nums", color: C.text, fontSize: 14 },
